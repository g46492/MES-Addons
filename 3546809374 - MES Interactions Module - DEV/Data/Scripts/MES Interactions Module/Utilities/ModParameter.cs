...
namespace PEPCO.Utilities
{
    ...
    {
        public static readonly string MODNAME = "MES Interactions Module";

        /// <summary>
        /// Human-readable mod version string.
        /// Often replaced/injected by a build script; keep stable formatting for tooling.
        /// </summary>
        public static readonly string PEPCOVERSION = "1773135639";
    ...
    public class PEPCOMOD : MySessionComponentBase
    {
        ...
        public override void LoadData()
        {
            try
            {
                ...
                {
                    MyLog.Default.WriteLineAndConsole($"Error in {ModParameter.MODNAME}: Could not determine ModContext.");
                }
